...
public class OVRGrabber : MonoBehaviour
{
    ...
    //Modified
    protected void GrabbableRelease(Vector3 linearVelocity, Vector3 angularVelocity, Vector3 cross)
    {
        m_grabbedObj.GrabEnd(linearVelocity, angularVelocity, cross);
        if (m_parentHeldObject) m_grabbedObj.transform.parent = null;
        m_grabbedObj = null;
    }
